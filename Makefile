deploy_elastic:
    ...
    ES_JAVA_OPTS="-Xms6g -Xmx6g"  docker run -e "ES_JAVA_OPTS=-Xms6g -Xmx6g"  --name elastic -d -p 9200:9200 -p 9300:9300 -v /root/esdata1:/usr/share/elasticsearch/data -e "discovery.type=single-node" docker.elastic.co/elasticsearch/elasticsearch:7.10.1
deploy_kibana:
